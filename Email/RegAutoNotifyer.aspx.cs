...
{
    public partial class RegAutoNotifyer : System.Web.UI.Page
    {
        ...
        {
            //Label1.Text = string.Format("Total {0} users(s) listed", GridView1.Rows.Count);
        }
        ...
        {
            Label1.Text = string.Format("Total {0} user(s) listed", e.AffectedRows.ToString());
        }
    }
}
