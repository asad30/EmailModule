...
<body>
    ...
    <form id="form1" runat="server">
        <div class="BodyContainer" style="width: 1450px;">
            ...
            <div class="division">
                ...
                <div>
                    ...
                    <div class="columnMulti">
                        ...
                        - &nbsp;
                        <asp:TextBox ID="txtAgeRangeEnd" runat="server" MaxLength="2" Text="99" Width="30"></asp:TextBox>
                        Years
                    </div>
                    <div class="clear">
                    </div>
            ...
            <div class="division">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div class="columnMulti">
                            <asp:TextBox ID="txtSentCount" runat="server" Text="0" Width="30" MaxLength="4"></asp:TextBox>
                        </div>
                        <div class="clear">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="columnMulti">
                            <asp:TextBox ID="txtOpenedCount" runat="server" Text="0" Width="30" MaxLength="4"></asp:TextBox>
                        </div>
                        <div class="clear">
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="columnMulti">
                            <asp:TextBox ID="txtOpenRate" runat="server" Text="0" Width="30" MaxLength="3"></asp:TextBox> %
                        </div>
                        <div class="clear">
                        </div>
                    </div>
            ...
            <div>
                <asp:GridView ID="gvUsers" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="EmailSendCount" HeaderText="Sent" SortExpression="EmailSendCount" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"/>
                        <asp:BoundField DataField="EmailOpenCount" HeaderText="Opened" SortExpression="EmailOpenCount" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"/>
                        <asp:BoundField DataField="EmailOpenRate" HeaderText="OpenRate" SortExpression="EmailOpenRate" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"/>
                        <asp:BoundField DataField="EmailBounceCount" HeaderText="Bounced" SortExpression="EmailBounceCount" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"/>
                        ...
                        <asp:BoundField DataField="CorporateID" HeaderText="Company ID" SortExpression="CorporateID" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"/>
            ...
            <div id="scheduleNowDiv" style="height: 30px;">
                <div class="columnFirst">
                    &nbsp;
                </div>
            ...
            <div id="scheduleTokenDiv" style="height: 30px;">
                <div class="columnFirst">
                    &nbsp;
                </div>
            ...
            <div>
                <div class="columnFirst">
                    <asp:CheckBox ID="chkReschedule1" CssClass="clsReschedule1" runat="server" />
                    <asp:Label ID="lblReschedule1" runat="server" Text="Re-schedule"></asp:Label>
                </div>
                <div class="reschedule1columnSecond columnSecond" style="display: none;">
                    <asp:DropDownList ID="ddlReschedule1" runat="server">
                        <asp:ListItem Selected="True" Value="D1">After 1 Day</asp:ListItem>
                        <asp:ListItem Value="D2">After 2 Days</asp:ListItem>
                        <asp:ListItem Value="D3">After 3 Days</asp:ListItem>
                        <asp:ListItem Value="D4">After 4 Days</asp:ListItem>
                        <asp:ListItem Value="D5">After 5 Days</asp:ListItem>
                        <asp:ListItem Value="D6">After 6 days</asp:ListItem>
                        <asp:ListItem Value="D7">After 7 Days</asp:ListItem>
                        <asp:ListItem Value="D8">After 8 days</asp:ListItem>
                        <asp:ListItem Value="D9">After 9 days</asp:ListItem>
                        <asp:ListItem Value="D10">After 10 days</asp:ListItem>
                        <asp:ListItem Value="D15">After 15 days</asp:ListItem>
                        <asp:ListItem Value="D20">After 20 days</asp:ListItem>
                        <asp:ListItem Value="D25">After 25 days</asp:ListItem>
                        <asp:ListItem Value="M1">After 1 month</asp:ListItem>
                        <asp:ListItem Value="D45">After 45 days</asp:ListItem>
                        <asp:ListItem Value="M2">After 2 months</asp:ListItem>
                        <asp:ListItem Value="M3">After 3 months</asp:ListItem>
                        <asp:ListItem Value="M4">After 4 months</asp:ListItem>
                        <asp:ListItem Value="M5">After 5 months</asp:ListItem>
                        <asp:ListItem Value="M6">After 6 months</asp:ListItem>
                        <asp:ListItem Value="M7">After 7 months</asp:ListItem>
                        <asp:ListItem Value="M8">After 8 months</asp:ListItem>
                        <asp:ListItem Value="M9">After 9 months</asp:ListItem>
                        <asp:ListItem Value="M10">After 10 months</asp:ListItem>
                        <asp:ListItem Value="M11">After 11 months</asp:ListItem>
                        <asp:ListItem Value="Y1">After 1 year</asp:ListItem>
                    </asp:DropDownList>
            ...
            <div>
                <div id="reschedule2div" style="display: none;">
                    <div class="columnFirst">
                        <asp:CheckBox ID="chkReschedule2" CssClass="clsReschedule2" runat="server" />
                        <asp:Label ID="lblReschedule2" runat="server" Text="Re-schedule"></asp:Label>
                    </div>
                    <div class="reschedule2columnSecond columnSecond" style="display: none;">
                        <asp:DropDownList ID="ddlReschedule2" runat="server">
                            <asp:ListItem Selected="True" Value="D1">After 1 Day</asp:ListItem>
                            <asp:ListItem Value="D2">After 2 Days</asp:ListItem>
                            <asp:ListItem Value="D3">After 3 Days</asp:ListItem>
                            <asp:ListItem Value="D4">After 4 Days</asp:ListItem>
            ...
            <div>
                <div id="reschedule3div" style="display: none;">
                    <div class="columnFirst">
                        <asp:CheckBox ID="chkReschedule3" CssClass="clsReschedule3" runat="server" />
                        <asp:Label ID="lblReschedule3" runat="server" Text="Re-schedule"></asp:Label>
                    </div>
                    <div class="reschedule3columnSecond columnSecond" style="display: none;">
                        <asp:DropDownList ID="ddlReschedule3" runat="server">
                            <asp:ListItem Selected="True" Value="D1">After 1 Day</asp:ListItem>
                            <asp:ListItem Value="D2">After 2 Days</asp:ListItem>
                            <asp:ListItem Value="D3">After 3 Days</asp:ListItem>
                            <asp:ListItem Value="D4">After 4 Days</asp:ListItem>
            ...
            <div>
                <div id="reschedule4div" style="display: none;">
                    <div class="columnFirst">
                        <asp:CheckBox ID="chkReschedule4" CssClass="clsReschedule4" runat="server" />
                        <asp:Label ID="lblReschedule4" runat="server" Text="Re-schedule"></asp:Label>
                    </div>
                    <div class="reschedule4columnSecond columnSecond" style="display: none;">
                        <asp:DropDownList ID="ddlReschedule4" runat="server">
                            <asp:ListItem Selected="True" Value="D1">After 1 Day</asp:ListItem>
                            <asp:ListItem Value="D2">After 2 Days</asp:ListItem>
                            <asp:ListItem Value="D3">After 3 Days</asp:ListItem>
                            <asp:ListItem Value="D4">After 4 Days</asp:ListItem>
            ...
            <div>
                <div id="reschedule5div" style="display: none;">
                    <div class="columnFirst">
                        <asp:CheckBox ID="chkReschedule5" CssClass="clsReschedule5" runat="server" />
                        <asp:Label ID="lblReschedule5" runat="server" Text="Re-schedule"></asp:Label>
                    </div>
                    <div class="reschedule5columnSecond columnSecond" style="display: none;">
                        <asp:DropDownList ID="ddlReschedule5" runat="server">
                            <asp:ListItem Selected="True" Value="D1">After 1 Day</asp:ListItem>
                            <asp:ListItem Value="D2">After 2 Days</asp:ListItem>
                            <asp:ListItem Value="D3">After 3 Days</asp:ListItem>
                            <asp:ListItem Value="D4">After 4 Days</asp:ListItem>
            ...
            <div>
                <div id="reschedule6div" style="display: none;">
                    <div class="columnFirst">
                        <asp:CheckBox ID="chkReschedule6" CssClass="clsReschedule6" runat="server" />
                        <asp:Label ID="lblReschedule6" runat="server" Text="Re-schedule"></asp:Label>
                    </div>
                    <div class="reschedule6columnSecond columnSecond" style="display: none;">
                        <asp:DropDownList ID="ddlReschedule6" runat="server">
                            <asp:ListItem Selected="True" Value="D1">After 1 Day</asp:ListItem>
                            <asp:ListItem Value="D2">After 2 Days</asp:ListItem>
                            <asp:ListItem Value="D3">After 3 Days</asp:ListItem>
                            <asp:ListItem Value="D4">After 4 Days</asp:ListItem>
    ...
    <script type="text/javascript" language="javascript">
      $(document).ready(function() {
        $('#chkReschedule1').change(function(){
            if($('#chkReschedule1').is(':checked')){
                    $('.reschedule1columnSecond').show('fast');
                    $('#reschedule2div').show('fast');                    
                }else{
                    $('.reschedule1columnSecond').hide('fast');
                    $('#chkReschedule6').attr('checked','')
                    $('.reschedule6columnSecond').hide('fast');
                    $('#chkReschedule5').attr('checked','')
                    $('.reschedule5columnSecond').hide('fast');
                    $('#chkReschedule4').attr('checked','')
                    $('.reschedule4columnSecond').hide('fast');
                    $('#chkReschedule3').attr('checked','')
                    $('.reschedule3columnSecond').hide('fast');
                    $('#chkReschedule2').attr('checked','')
                    $('.reschedule2columnSecond').hide('fast');
                    $('#reschedule6div').hide('fast');
                    $('#reschedule5div').hide('fast');
                    $('#reschedule4div').hide('fast');
                    $('#reschedule3div').hide('fast'); 
                    $('#reschedule2div').hide('fast'); 
                }
        });
        $('#chkReschedule2').change(function(){
            if($('#chkReschedule2').is(':checked')){
                    $('.reschedule2columnSecond').show('fast');
                    $('#reschedule3div').show('fast');                    
                }else{
                    $('.reschedule2columnSecond').hide('fast');
                    $('#chkReschedule6').attr('checked','')
                    $('.reschedule6columnSecond').hide('fast');
        ...
        $('#chkReschedule3').change(function(){
            if($('#chkReschedule3').is(':checked')){
                    $('.reschedule3columnSecond').show('fast');
                    $('#reschedule4div').show('fast');                    
                }else{
                    $('.reschedule3columnSecond').hide('fast');
                    $('#chkReschedule6').attr('checked','')
                    $('.reschedule6columnSecond').hide('fast');
        ...
        $('#chkReschedule4').change(function(){
            if($('#chkReschedule4').is(':checked')){
                    $('.reschedule4columnSecond').show('fast');
                    $('#reschedule5div').show('fast');                    
                }else{
                    $('.reschedule4columnSecond').hide('fast');
                    $('#chkReschedule6').attr('checked','')
                    $('.reschedule6columnSecond').hide('fast');
        ...
        $('#chkReschedule5').change(function(){
            if($('#chkReschedule5').is(':checked')){
                    $('.reschedule5columnSecond').show('fast'); 
                    $('#reschedule6div').show('fast');                   
                }else{
                    $('.reschedule5columnSecond').hide('fast');
                    $('#chkReschedule6').attr('checked','')
                    $('.reschedule6columnSecond').hide('fast');                    
        ...
        $('#chkReschedule6').change(function(){
            if($('#chkReschedule6').is(':checked')){
                    $('.reschedule6columnSecond').show('fast');         
                }else{
                    $('.reschedule6columnSecond').hide('fast');
                }
        });
